...
export const TRANSLATIONS = {
  pt: {
    ...
    admin: {
      ...
      aiDirector: 'Diretor de Evento IA',
      createPoll: 'Criar Enquete ao Vivo',
      createSurvey: 'Criar Pesquisa de Feedback',
      drafting: 'Gerando...',
  ...
  en: {
    ...
    admin: {
      ...
      aiDirector: 'AI Event Director',
      createPoll: 'Create Live Poll',
      createSurvey: 'Create Feedback Survey',
      drafting: 'Drafting...',

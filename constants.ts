...
export const TRANSLATIONS = {
  pt: {
    ...
    stage: {
      ...
      share: 'Compartilhar',
      noHtmlContent: 'Nenhum conteúdo HTML carregado',
      loadContentFromAdmin: 'Use o painel de controle admin para carregar conteúdo'
    },
    engagement: {
      chat: 'Chat',
      qa: 'Q&A',
    ...
    admin: {
      ...
      playerSizeControl: 'Controle de Tamanho do Player',
      fullSize: 'Tamanho Total',
      fullSizeDesc: 'Player ocupa toda a tela',
      mediumSize: 'Tamanho Médio',
      mediumSizeDesc: '2/3 da tela para o player',
      smallSize: 'Tamanho Pequeno',
      smallSizeDesc: '1/2 da tela para o player',
      htmlContentArea: 'Área de Conteúdo HTML',
      sampleSurvey: 'Pesquisa de Exemplo',
      sampleAd: 'Anúncio de Exemplo',
      loadSurvey: 'Carregar Pesquisa',
      loadAd: 'Carregar Anúncio',
      clearContent: 'Limpar Conteúdo',
      customHtml: 'HTML Personalizado',
      htmlPlaceholder: 'Cole seu código HTML aqui...',
      loadCustomHtml: 'Carregar HTML Personalizado',
      activeContent: 'Conteúdo Ativo',
      quickFeedback: 'Feedback Rápido',
      surveyQuestion: 'Como você está avaliando esta sessão?',
      excellent: 'Excelente',
      good: 'Bom',
      average: 'Regular',
      poor: 'Fraco',
      adTitle: 'Nova Plataforma Disponível!',
      adDescription: 'Experimente nossos recursos premium e leve seus eventos ao próximo nível.',
  ...
  en: {
    ...
    stage: {
      ...
      share: 'Share',
      noHtmlContent: 'No HTML content loaded',
      loadContentFromAdmin: 'Use the admin control panel to load content'
    },
    engagement: {
      chat: 'Chat',
      qa: 'Q&A',
    ...
    admin: {
      ...
      playerSizeControl: 'Player Size Control',
      fullSize: 'Full Size',
      fullSizeDesc: 'Player takes full screen',
      mediumSize: 'Medium Size',
      mediumSizeDesc: '2/3 of screen for player',
      smallSize: 'Small Size',
      smallSizeDesc: '1/2 of screen for player',
      htmlContentArea: 'HTML Content Area',
      ...
      loadCustomHtml: 'Load Custom HTML',
      activeContent: 'Active Content',
      quickFeedback: 'Quick Feedback',
      surveyQuestion: 'How are you rating this session?',
      excellent: 'Excellent',
      good: 'Good',
      average: 'Average',
      poor: 'Poor',
      adTitle: 'New Platform Available!',
      adDescription: 'Try our premium features and take your events to the next level.',
